#this is for generating summary of 15 sentences(200 words approx), threshold for inclusion of sentence in problem is 0.2, for inclusion of sentence in summary is 0.5 and target is to minimise summation of length*value of sentence(unweighted), and threshold for putting a fragment in a cluster is 0.07, no extra stop words included.
...
def set_cover(b,q,l,cluster,sentences,folder):
	...
	LD = open('simvipfragmenting/Summary2/'+folder +'_reference3.txt', 'w')
	for i in summary:
		LD.write(i+'\n')                
	LD.close();
