...
def set_cover(b,q,l,cluster,sentences,folder, sent_score):
	...
	for c in cluster :
		...
		#LD.write('\n\n\n\n\n')
	LD = open('simvipfragmenting/Summary7f_4/'+folder +'_reference.txt', 'w')
	for i in summary:
		LD.write(i+'\n')                
	LD.close();
...
if not os.path.exists("simvipfragmenting/Summary7f_4"):
	os.mkdir("simvipfragmenting/Summary7f_4")
