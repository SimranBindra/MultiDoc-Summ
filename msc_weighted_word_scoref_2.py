...
def set_cover(b,q,l,cluster,sentences,folder, sent_score):
	...
	LD = open('simvipfragmenting/Summary8f_4/'+folder +'_reference.txt', 'w')
	for i in summary:
		LD.write(i+'\n')                
	LD.close();
...
if not os.path.exists("simvipfragmenting/Summary8f_4"):
	os.mkdir("simvipfragmenting/Summary8f_4")
