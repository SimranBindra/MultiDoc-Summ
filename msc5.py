#this is for generating summary of 200 words, threshold for inclusion of sentence in problem is 0.2, for inclusion of sentence in summary is 0.8 and target is to minimise summation of length*value of sentence(unweighted), and threshold for putting a fragment in a cluster is 0.07, no extra stop words included.
...
def set_cover(b,q,l,cluster,sentences,folder):
	...
	summary=[]
	x=0
	LD = open('simvipfragmenting/Summary5/'+folder +'_mini_reference5.txt', 'w')
	for c in cluster :
		minisummary=[]
		n=len(c)
		m=len(sentences)
...
if not os.path.exists("simvipfragmenting/Summary5"):
	os.mkdir("simvipfragmenting/Summary5")
