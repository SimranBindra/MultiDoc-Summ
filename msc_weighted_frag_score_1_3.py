...
def set_cover(b,q,l,cluster,sentences,folder, sent_score):
	...
	for c in cluster :
		...
		for i in minisummary:
			...
			sentences.remove(i[1])'''
		#LD.write('\n\n\n\n\n')
	LD = open('simvipfragmenting/Summary9_3/'+folder +'_reference.txt', 'w')
	for i in summary:
		LD.write(i+'\n')                
	LD.close();
...
if not os.path.exists("simvipfragmenting/Summary9_3"):
	os.mkdir("simvipfragmenting/Summary9_3")
